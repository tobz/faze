        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <CopyButton text={span.span_id} label="Copy ID" />
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <CopyButton text={span.trace_id} label="Copy ID" />
            </div>
            <p className="text-xs font-mono text-foreground/70 break-all">
              {span.trace_id}
            </p>
          ...
          {span.parent_span_id && (
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <CopyButton text={span.parent_span_id} label="Copy ID" />
              </div>
              <p className="text-xs font-mono text-foreground/70 break-all">
                {span.parent_span_id}
              </p>
